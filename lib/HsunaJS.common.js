...
var isRegexp = function (it) {
  var isRegExp
  return (
    isObject(it) && ((isRegExp = it[MATCH]) !== undefined ? !!isRegExp : classofRaw(it) == "RegExp")
  )
}
  ...
  createClass(NodeIterator, [
    ...
    },
    {
      ...
      value: function createScope() {
        var blockType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "block"
